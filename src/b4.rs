...
impl<'a, K: CollKey + 'a, V: 'a> B4Node<K, V> {
...
impl<'a, K: CollKey + 'a, V: 'a> BTNode<'a, K, V> for B4Node<K, V> {
...
impl<'a, K: CollKey + 'a, V: 'a> Dictionary<K, V> for B4<K, V> {
...
impl<'a, K: CollKey + 'a, V: 'a> BT<'a, K, V> for B4<K, V> {
    fn order(&self) -> usize {
        4
    }
